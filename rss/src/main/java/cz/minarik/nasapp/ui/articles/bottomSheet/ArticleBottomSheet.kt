...
import cz.minarik.nasapp.databinding.BottomSheetArticleBinding
import cz.minarik.nasapp.ui.base.BaseBottomSheet
import cz.minarik.nasapp.utils.Constants
import java.net.MalformedURLException
import java.net.URL

class ArticleBottomSheet : BaseBottomSheet<BottomSheetArticleBinding>() {

    override fun getViewBinding(): BottomSheetArticleBinding =
        BottomSheetArticleBinding.inflate(layoutInflater)
